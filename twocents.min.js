...
function convertAnchorsToButtons() {
    each(find(".twocents_admin_tools a, .twocents_new_comment a, .twocents_form_buttons a"), function (anchor) {
...
function prepareForm() {
    ...
    each(find(".twocents_form"), function (form) {
        conf = JSON.parse(form.dataset.config);
    });
    each(find(".twocents_form_buttons button"), function (button) {
