...
(function () {
    ...
    function ajaxifyAdminTools() {
        ...
        each(find(".twocents_admin_tools form"), function (form) {
            form.onsubmit = (function () {
                if (currentButton.dataset.action === "delete") {
                    var confirmed = window.confirm(conf.message_delete);
                    if (!confirmed) {
                        return false;
                    }
                }
                var params = [];
                each([this["xh_csrf_token"], currentButton], function (element) {
    ...
    function prepareForm() {
        ...
        function hideForm(form) {
            ...
            if (form.previousSibling.nodeName.toLowerCase() !== "p") {
                ...
                button.innerHTML = conf.label_new;
     ...
     */
    init = function () {
        conf = JSON.parse(document.getElementsByTagName("meta")["twocents"].content);
        ajaxifyPagination();
        convertAnchorsToButtons();
        ajaxifyAdminTools();
        prepareForm();
        if (conf.comments_markup === "HTML") {
            if (isRteSupported()) {
