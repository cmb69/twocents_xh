...
$plugin_tx['twocents']['message_converted_html']="%d comments have been converted to HTML. Change the configuration accordingly.";
$plugin_tx['twocents']['message_converted_plain']="%d comments have been converted to plain text. Change the configuration accordingly.";
$plugin_tx['twocents']['message_imported_comments']="%d comments of the Comments plugin have been imported.";
$plugin_tx['twocents']['message_imported_gbook']="%d comments of the GBook plugin have been imported.";
...
$plugin_tx['twocents']['syscheck_extension']="the PHP extension '%s' is loaded";
$plugin_tx['twocents']['syscheck_fail']="failure";
$plugin_tx['twocents']['syscheck_message']="Checking that %1\$s … %2\$s";
$plugin_tx['twocents']['syscheck_phpversion']="the PHP version is at least %s";
$plugin_tx['twocents']['syscheck_plugin']="the CMSimple_XH plugin '%s' is installed";
...
$plugin_tx['twocents']['syscheck_xhversion']="the CMSimple_XH version is at least %s";
